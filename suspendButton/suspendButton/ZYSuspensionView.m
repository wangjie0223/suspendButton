...
- (void)show
{
    ...
    backWindow.backgroundColor = [UIColor grayColor];
    ...
    self.frame = CGRectMake(20, 20, self.frame.size.width - 40, self.frame.size.height - 40);
    //将方形切换为圆形
    ...
    self.closeBtn = [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width,0 , 30, 30)];
    [self.closeBtn setTitle:@"X" forState:UIControlStateNormal];
    self.closeBtn.backgroundColor = [UIColor redColor];
    [backWindow addSubview:self.closeBtn];
